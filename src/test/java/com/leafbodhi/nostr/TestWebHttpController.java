...
class TestWebHttpController {
	...
	void testHttpForJsonAccept() throws Exception {
		mockMvc.perform(MockMvcRequestBuilders.get("/").accept(MediaType.APPLICATION_JSON).param("http", ""))
	...
	void testHttpForNostrAccept() throws Exception {
		MvcResult result = mockMvc
				.perform(MockMvcRequestBuilders.get("/").accept("application/nostr+json").param("nostr", ""))
